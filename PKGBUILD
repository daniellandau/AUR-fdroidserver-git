...
license=('GPL3')
depends=('python2' 'python2-pyasn1' 'python2-pyasn1-modules')
makedepends=('git' 'python2-setuptools' 'python2-magic' 'python2-pillow' 'python2-paramiko' 'java-environment')
optdepends=(
     ...
     'python2-magic: Scan source code builds for prebuilt binaries'
